...
ASSETS_PREFIX_IN_DATA = "assets/carousel"   # lo que guardamos en yellow_family.js (strings)
PROJECT_ROOT_FROM_HERE = "../.."            # estando en assets/carousel -> subimos a raíz

YELLOW_FAMILY_JS_OUT = os.path.join(PROJECT_ROOT_FROM_HERE, "src", "data", "yellow_family.js")
...
def write_yellow_family_js(seasons, out_file):
    ensure_dir_for_file(out_file)
    content = []
    content.append("// AUTO-GENERATED FILE. DO NOT EDIT MANUALLY.\n")
    content.append("// Generated by assets/carousel/generate_yellow_family_json.py\n\n")
...
def write_images_map_js(image_filenames, out_file, require_prefix):
    ...
    lines.append("// Generated by assets/carousel/generate_yellow_family_json.py\n\n")
...
def main():
    ...
    # 1) yellow_family.js
    write_yellow_family_js(seasons, YELLOW_FAMILY_JS_OUT)
    ...
    print("OK -> generado", YELLOW_FAMILY_JS_OUT)
