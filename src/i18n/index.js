...
const STRINGS = {
  es: {
    ...
    addSeriesTitle: "Añadir serie manualmente",
    addSeriesSubtitle: "Añadir una serie sin estar sincronizada con la Raspberry Pi TV",
    addSelectedSeries: "Añadir",
    seriesSearchPlaceholder: "Escribe el nombre de una serie",
    searchingSeries: "Buscando series...",
    noSeriesResults: "Aún no se han encontrado resultados para la búsqueda.",
    seriesSearchHint: "Busca una serie para añadir.",
    ...
    seriesImageLabel: "Imagen de cabecera",
    seriesImageSelected: "Carátula seleccionada",
    seriesImageUse: "Usar esta imagen",
    seriesImagesEmpty: "No hay imágenes disponibles para esta serie.",
    seriesImageCropLabel: "Vista previa del cartel",
    seriesImageCropHint:
      "Arrastra la imagen y ajusta el zoom para elegir qué zona se verá en el cartel.",
  ...
  en: {
    ...
    addSeriesTitle: "Add series manually",
    addSeriesSubtitle: "Add a series without syncing it with the Raspberry Pi TV",
    addSelectedSeries: "Add",
    seriesSearchPlaceholder: "Type a TV series name",
    searchingSeries: "Searching series...",
    noSeriesResults: "There are no results for this search yet.",
    seriesSearchHint: "Search for a series to add.",
    ...
    seriesImageLabel: "Header image",
    seriesImageSelected: "Selected cover",
    seriesImageUse: "Use this image",
    seriesImagesEmpty: "No images are available for this series.",
    seriesImageCropLabel: "Poster preview",
    seriesImageCropHint:
      "Drag the image and adjust zoom to choose which area is shown on the poster.",
